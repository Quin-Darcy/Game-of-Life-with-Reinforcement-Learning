...
pub const MAX_STATE_SPACE_SIZE: usize = 500;

// Constants controlling exploration and exploitation
pub const EPSILON: f32 = 0.4;
pub const MAX_EPSILON : f32 = 0.8;
pub const MIN_EPSILON : f32 = 0.05;
pub const INCREASE_FACTOR : f32 = 0.1;
pub const DECREASE_FACTOR : f32 = 0.1;
...
pub const CROSSOVER_RATE: f32 = 0.64;
